...
export declare class jsonsplitterClient {
    ...
    sendType: (type?: string, parameters?: any, stuff?: Record<string, any>, noReject?: boolean) => Promise<unknown>;
    sendTypeSync: (type?: string, parameters?: any, stuff?: Record<string, any>, cb?: Function) => void;
    connectClient(): Promise<void>;
    createcb: (cb: any) => any;
    getKeySync: (keypath: string | string[], noReject?: boolean) => Promise<unknown>;
    addKeySync: (keypath: string | string[], value?: any, noReject?: boolean) => Promise<unknown>;
    editKeySync: (keypath: string | string[], value?: any, noReject?: boolean) => Promise<unknown>;
    editKeyAddSync: (keypath: string | string[], value?: any, noReject?: boolean) => Promise<unknown>;
    deleteKeySync: (keypath: string | string[], noReject?: boolean) => Promise<unknown>;
}
export {};
